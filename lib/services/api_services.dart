...
Future<List<String>> fetchCableTypes() async {
  final response = await http
      .get(Uri.parse('https://devqms.triasmitra.com/public/api/cable-types'));
...
Future<List<String>> fetchCategoryItems(String cableType) async {
  final response = await http.get(Uri.parse(
      'https://devqms.triasmitra.com/public/api/category-items/$cableType'));
...
Future<List<String>> fetchItems(String categoryItem, String cableType) async {
  final response = await http.get(Uri.parse(
      'https://devqms.triasmitra.com/public/api/items/$categoryItem/$cableType'));
...
Future<List<String>> fetchCategoryItemCode(
  ...
  final response = await http.get(Uri.parse(
      'https://devqms.triasmitra.com/public/api/category-item-code/$item/$categoryItem'));
...
class ApiService {
  ...
  Future<String> createInspectionTicket(
    ...
    const String url =
        'https://devqms.triasmitra.com/public/api/create-inspection';
  ...
  Future<String> createAuditTicket(
      ...
      String worker,
      String servicePoint) async {
    const String url = 'https://devqms.triasmitra.com/public/api/create-audit';
  ...
  Future<void> updateInspectionTicketStatusOnProgress(
    ...
    const String url =
        'https://devqms.triasmitra.com/public/api/inspection/update-status-progress';
  ...
  Future<void> updateAuditTicketStatusOnProgress(
    ...
    const String url =
        'https://devqms.triasmitra.com/public/api/audit/update-status-progress';
  ...
  Future<void> updateInspectionTicketStatusSubmitted(
      String idInspection, String newStatus) async {
    const String url =
        'https://devqms.triasmitra.com/public/api/inspection/update-status-submitted';
  ...
  Future<void> updateAuditTicketStatusSubmitted(
      String idAudit, String newStatus) async {
    const String url =
        'https://devqms.triasmitra.com/public/api/audit/update-status-submitted';
  ...
  Future<List<Inspection>> fetchAllInspections(String username) async {
    final response = await http.get(Uri.parse(
        'https://devqms.triasmitra.com/public/api/inspection/$username'));
  ...
  Future<List<Audit>> fetchAllAudits(String username) async {
    final response = await http.get(
        Uri.parse('https://devqms.triasmitra.com/public/api/audit/$username'));
  ...
  Future<List<Inspection>> fetchInspectionByTicket(String idInspection) async {
    ...
    final response = await http.get(Uri.parse(
        'https://devqms.triasmitra.com/public/api/inspection/id/$idInspection'));
  ...
  Future<List<Audit>> fetchAuditByTicket(String idAudit) async {
    ...
    final response = await http.get(Uri.parse(
        'https://devqms.triasmitra.com/public/api/audit/id/$idAudit'));
  ...
  Future<InspectionResponse> fetchInspectionByTicket2(String qmsTicket) async {
    ...
    final response = await http.get(Uri.parse(
        'https://devqms.triasmitra.com/public/api/inspection/asset/$qmsTicket'));
  ...
  Future<AuditResponse> fetchAuditByTicket2(String qmsTicket) async {
    ...
    final response = await http.get(Uri.parse(
        'https://devqms.triasmitra.com/public/api/audit/asset/$qmsTicket'));
  ...
  Future<Map<String, dynamic>> postAssetTaggingInspection(
    ...
    const String url =
        'https://devqms.triasmitra.com/public/api/asset-tagging-inspection';
  ...
  Future<Map<String, dynamic>> postAssetTaggingAudit(
      Map<String, dynamic> payload) async {
    const String url =
        'https://devqms.triasmitra.com/public/api/asset-tagging-audit';
  ...
  Future<List<AssetTaggingInspection>> getAssetTaggingInspection(
    ...
    final response = await http.get(Uri.parse(
        'https://devqms.triasmitra.com/public/api/asset-tagging-inspection/$idInspection'));
  ...
  Future<List<AssetTaggingAudit>> getAssetTaggingAudit(String idAudit) async {
    final response = await http.get(Uri.parse(
        'https://devqms.triasmitra.com/public/api/asset-tagging-audit/$idAudit'));
  ...
  Future<void> updateAssetTaggingInspectionStatus({
    ...
    const String url =
        'https://devqms.triasmitra.com/public/api/asset-tagging-inspection/update';
    final response = await http.put(
      Uri.parse(url),
      headers: <String, String>{
        'Content-Type': 'application/json',
  ...
  Future<void> updateAssetTaggingAuditStatus({
    ...
    const String url =
        'https://devqms.triasmitra.com/public/api/asset-tagging-audit/update';
    final response = await http.put(
      Uri.parse(url),
      headers: <String, String>{
        'Content-Type': 'application/json',
  ...
  Future<String> createDefectId({
    ...
    const String url =
        'https://devqms.triasmitra.com/public/api/create-defect-id';
  ...
  Future<void> postInspectionResult({
    ...
    var uri =
        Uri.parse('https://devqms.triasmitra.com/public/api/inspection-result');
  ...
  Future<void> postAuditResult({
    ...
    var uri =
        Uri.parse('https://devqms.triasmitra.com/public/api/audit-result');
    var request = http.MultipartRequest('POST', uri);
  ...
  Future<void> updateTicketStatusInspectionResult(
    ...
    const String url =
        'https://devqms.triasmitra.com/public/api/inspection-result/update-status';
  ...
  Future<void> updateTicketStatusAuditResult(
    ...
    const String url =
        'https://devqms.triasmitra.com/public/api/audit-result/update-status';
  ...
  Future<List<Map<String, dynamic>>> getInspectionResultsByTagging(
    ...
    final response = await http.get(Uri.parse(
        'https://devqms.triasmitra.com/public/api/inspection-result/$idInspection/$nama'));
  ...
  Future<List<Map<String, dynamic>>> getAuditResultsByTagging(
    ...
    final response = await http.get(Uri.parse(
        'https://devqms.triasmitra.com/public/api/audit-result/$idAudit/$nama'));
